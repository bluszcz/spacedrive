...
// Patched header - CoreFoundation types defined inline to avoid include issues
#include <stdint.h>

#ifdef __APPLE__
// Basic CoreFoundation types without including the full header
